            ...
            return (
                <div className='Card-table' style={this.props.style}>
                    <div onClick={() => this.removeOne('handS')} id='bottom'
                        ...
                        <Hand__ hide={false} fan={false} stack={true} cards={this.state.handS} cardSize={this.cardSize}/>
                    </div>
                    <div onClick={() => this.removeOne('handW')} id='left' style={{
                        ...
                        <Hand__ rotate={90} fan={true} hide={false} cards={this.state.handW} cardSize={this.cardSize}/>
                    </div>
                    <div onClick={() => this.removeOne('handN')} id='top'
                         style={{'right': '50%', 'top': -this.cardSize * .5, 'position': 'absolute'}}>
                        <Hand__ rotate={180} fan={true} hide={false} cards={this.state.handN} cardSize={this.cardSize}/>
                    </div>
                    <div onClick={() => this.removeOne('handE')} id='right' style={{
                        ...
                        <Hand__ rotate={270} hide={true} fan={false} spread={true} cards={this.state.handE}
            ...
            return (
                <div className='Card-table' style={this.props.style}>
                    <div id='top' style={{'right': '50%', 'top': -this.cardSize * .5, 'position': 'absolute'}}>
                        <Hand__ onClick={this.onClick.bind(this)} handId={'handN'} rotate={180} layout={"fan"} hide={true}
                    ...
                    <div id='bottom' style={styles.twoHand(this.cardSize).handS}>
                        <Hand__ onClick={this.onClick.bind(this)} handId={'handS'} hide={false} layout={"fan"}
            ...
            return (
                <div className='Card-table' style={this.props.style}>
                    <div id='bottom' style={styles.oneHand(this.cardSize).handS}>
                        <Hand__ hide={false} layout={"stack"} cards={this.state.handS} cardSize={this.cardSize}/>
                        <Hand__ hide={false} layout={"stack"} cards={this.state.handS} cardSize={this.cardSize}/>
                        <Hand__ hide={false} layout={"stack"} cards={this.state.handS} cardSize={this.cardSize}/>
                        <Hand__ hide={false} layout={"stack"} cards={this.state.handS} cardSize={this.cardSize}/>
                    </div>
